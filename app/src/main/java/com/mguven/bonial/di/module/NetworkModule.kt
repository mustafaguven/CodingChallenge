...
import com.mguven.bonial.BuildConfig
import com.mguven.bonial.di.interceptor.CacheInterceptor
import com.mguven.bonial.di.interceptor.HeaderInterceptor
import com.mguven.bonial.di.interceptor.LoggingInterceptor
...
class NetworkModule {
  ...
  fun provideOkHttpClient(@HeaderInterceptor headerInterceptor: Interceptor,
                          ...
                          bonialApplication: BonialApplication): OkHttpClient {
    return OkHttpClient.Builder()
        .cache(Cache(bonialApplication.cacheDir, CACHE_SIZE))
